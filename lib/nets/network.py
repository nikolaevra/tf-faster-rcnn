...
class Network(object):
    ...
    def _anchor_target_layer(self, rpn_cls_score, name):
        with tf.variable_scope(name) as scope:
            rpn_labels, rpn_bbox_targets, rpn_bbox_inside_weights, rpn_bbox_outside_weights = tf.py_func(
                anchor_target_layer,
                [rpn_cls_score, self._gt_boxes, self._im_info, self._feat_stride, self._anchors,
                 self._num_anchors],
    ...
    def _add_losses(self, sigma_rpn=3.0):
        with tf.variable_scope('LOSS_' + self._tag) as scope:
            ...
            rpn_loss_box = self._smooth_l1_loss(rpn_bbox_pred, rpn_bbox_targets,
                                                ...
                                                rpn_bbox_outside_weights, sigma=sigma_rpn,
                                                dim=[1, 2, 3])
    ...
    def create_architecture(self, mode, num_classes, tag=None, anchor_scales=(8, 16, 32),
        ...
        # Enable L2 regularization based on the config specification or disable it.
        ...
        # Creates arguments scopes that enable setting default layer parameters.
        with arg_scope([
            slim.conv2d, slim.conv2d_in_plane, slim.conv2d_transpose, slim.separable_conv2d,
