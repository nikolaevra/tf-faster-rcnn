...
from model.bbox_transform import bbox_transform_inv, clip_boxes, bbox_transform_inv_tf, \
    clip_boxes_tf
from model.nms_wrapper import nms


def proposal_layer(rpn_cls_prob, rpn_bbox_pred, im_info, cfg_key, _feat_stride, anchors,
                   num_anchors):
